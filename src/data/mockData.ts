...
export const publicTransporter: Transporter = {
  id: 't-public',
  name: 'Roberto Almeida',
  rating: 4.9,
  reviewsCount: 124,
  yearsExperience: 5,
  schools: ['Colégio Objetivo', 'Escola Adventista', 'COC'],
  neighborhoods: ['Centro', 'Vila Nova', 'Jd. América'],
  monthlyFee: 350,
  availableSeats: 3,
  vehiclePlate: 'ABC-1D34',
  capacity: 15,
};
...
export const publicReviews: Review[] = [
  {
    id: 'r1',
    authorName: 'Juliana S.',
    rating: 5,
    comment:
      'Excelente profissional, muito pontual e cuidadoso com as crianças. Meu filho adora ir com ele.',
  },
  {
    id: 'r2',
    authorName: 'Marcos T.',
    rating: 5,
    comment: 'Sempre avisa com antecedência se vai atrasar. Van sempre limpa e organizada.',
  },
];
